...
- [真题逐题分析](./chapters/00_exam_analysis.md)
- [考点频率分布](./chapters/00_frequency_map.md)
- [命题风格分析](./chapters/00_teacher_style.md)

# 🔴 Part A — Symbolic Logic (25%)

- [Propositional Logic & First-Order Logic](./chapters/A_symbolic_logic.md)

# 🔴 Part B — Logic Neural Networks (20%)

- [LNN & Differentiable Logic](./chapters/B_lnn.md)

# 🟡 Part C — Knowledge Representation

- [Expert Systems, Ontologies & KG Basics](./chapters/C_kr_methods.md)

# 🟠 Part D — Knowledge Graphs for AI (10%)

- [KG Construction, TransE & RAG](./chapters/D_knowledge_graphs.md)

# 🟡 Part E — MYCIN Expert System

- [Backward Chaining, Confidence Factors & Explanation](./chapters/E_mycin.md)

# 🔴 Part F — Decision Trees & Ensembles (15%)

- [Entropy, Bagging, Boosting & Random Forest](./chapters/F_decision_trees.md)

# 🔴 Part G — Soft Computing (20%)
...
# ✍️ Writing Training — Non-Native Speaker Drills
...
- [Mock Exam 1 — Answers](./chapters/mock_exam_1_answers.md)
- [Mock Exam 2 (Harder)](./chapters/mock_exam_2.md)
